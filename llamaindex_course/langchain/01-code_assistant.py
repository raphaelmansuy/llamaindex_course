...
# OPEN_API_BASE = "https://api.endpoints.anyscale.com/v1" # Use the default OpenAI API base URL
# API_KEY = "esecret_tanpq7t7m2u3dbfcmnvaamp7fb"  # Use the default OpenAI API base URL
...
def generate(state):
    ...
    # LLM
    model = ChatOpenAI(
        temperature=0, model=MODEL_NAME, streaming=True, base_url=OPEN_API_BASE, api_key=API_KEY)
...
workflow.add_node("check_code_execution",
                  check_code_execution)  # check execution
...
model = ChatOpenAI(temperature=0, model=MODEL_NAME, streaming=True,
                   base_url=OPEN_API_BASE, openai_api_key=API_KEY)
